    ...
    <ActionSection >
        ...
        <template #content>
            <div class="flex w-full mb-4">
                <div class="text-primary card-title">Sessões Ativas</div>
            </div>
            <div class="text-sm">
        ...
        ? session.agent.browser : 'Unknown' }}
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span v-if="session.is_current_device" class="font-semibold text-green-500">Este
                                    dispositivo</span>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Digite sua senha para confirmar que deseja sair das outras sessões do navegador em todos os seus
                    dispositivos.
